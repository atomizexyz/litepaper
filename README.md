...
180 Days after the launch of FENIX, the contract will enable Big Bonus. This bonus supply is deigned to reward the early adopters who chose to participate in the FENIX protocol.
...
- ![#F6B81A](https://via.placeholder.com/15/F6B81A/F6B81A.png) Stake & Early End Penalty Period - This time is between 0% and 100% of your your stake term. The stake term can be 1 day to 18250 days. Your stake stake will break even around 71% of your stake term completion.
...
FENIX has a fixed rate of inflation that is generated by stakers and paid to stakers. The supply of FENIX is uncapped. Outside of the two bonus events and the fixed inflation there are not other ways to produced FENIX. FENIX's inflation rate approximates to π.
...
**Staking Time Bonus (_𝞃_):** The amplification a base stake's bonus compounding at 20% APY. The duration of a stake term is uncapped but there are penalties for ending early and ending late.
...
- _𝞃_ — (Tau/Time Bonus) The time bonus calculating for a stake. This bonus rewards a staker the longer longer delay gratification.
