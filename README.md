...
FENIX has a fixed rate of inflation that is generated by stakers and paid to stakers. The supply of FENIX is uncapped. Outside of the two bonus events and the fixed inflation there are no other ways to produce FENIX. FENIX's inflation rate approximates to π.
